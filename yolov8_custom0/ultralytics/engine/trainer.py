        ...
        for epoch in range(self.start_epoch, self.epochs):
            ...
            for i, batch in pbar:
                ...
                with torch.cuda.amp.autocast(self.amp):
                    ...
                    # print(batch.keys())
                    # print(type(epoch), ">>>>>>>")
                    (self.loss, self.loss_items), cls_loss, all_losses = self.model(batch, epoch)
                    if RANK != -1:
                ...
                if i % 20 == 0:
                    ...
                    print("detect loss: ", self.loss)
                    print("classify loss: ", cls_loss)
                    print("-------------------------------------------------------------")

                (self.scaler.scale((self.loss)) + cls_loss).backward()
